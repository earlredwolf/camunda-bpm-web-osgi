...
public class GsonMessageBodyWriter implements MessageBodyWriter {
  ...
  @Override
  public void writeTo(Object value, Class aClass, Type type, Annotation[] annotations, MediaType mediaType, MultivaluedMap multivaluedMap, OutputStream outputStream) throws IOException, WebApplicationException {
